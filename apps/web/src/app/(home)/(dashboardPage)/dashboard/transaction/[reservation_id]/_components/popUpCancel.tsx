...
import { cancelTransaction } from "@/libs/fetch/transaction";
...
export default function PopUpCancel({
  ...
  const handleCancel = async () => {
    try {
      await cancelTransaction(reservation_id);
                  ...
                  <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        Mohon konfirmasi bahwa Anda ingin menolak pesanan ini.
                        Pengguna akan diberitahu tentang penolakan tersebut.
                      </p>
                    </div>
                  </div>
                </div>
