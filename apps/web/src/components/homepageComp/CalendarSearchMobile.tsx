...
export function CalendarSearchMobile({
  className,
  date,
  setDate
}: CalendarCompProps) {
  ...
  return (
    <div className={cn("grid gap-2", className)}>
      <div className="relative w-full pl-4 text-sm text-gray-500">
        <button
          id="date"
        ...
        {isActiveModal && (
          <div
            ref={modalRef}
            className="absolute z-10 mt-2 w-auto rounded border border-gray-300 bg-white shadow-lg"
          >
            <Calendar
              initialFocus
              mode="range"
